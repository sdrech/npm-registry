...
To install remoteDependencies and start the server in development mode:
...
- Look at the inner "remoteDependencies" object of a package for analysis of
  first-order remoteDependencies.

- npm returns dependency ranges that follow the
  [Semantic Versioning](https://semver.org/) specification, which you'll need to
  account for.

- The packages update from time to time, just as their remoteDependencies do.
